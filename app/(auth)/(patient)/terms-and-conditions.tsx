      ...
      <ScrollView className="flex-1 px-6 py-4">
        ...
        <View className="bg-red-50 p-4 rounded-xl border-2 border-red-200 mb-6">
          ...
          <Text className="text-sm text-red-800 leading-6">
            By clicking "Accept" and using the Health_Connect platform, you (the
            "User") confirm and irrevocably agree to the following legally
            binding terms. Your acceptance constitutes a complete and absolute
            waiver of your right to sue the platform.
          </Text>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-base text-gray-700 leading-6 ml-11">
            ...
            platform provides a logistical connection between you and
            independent healthcare practitioners. Under no circumstances is
            Health_Connect, its owners, directors, or employees a provider of
            medical care, diagnosis, advice, or treatment.
          </Text>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-base text-gray-700 leading-6 ml-11 mb-3">
            ...
            solely and exclusively with the independent healthcare provider you
            select.
          </Text>
          <View className="ml-11 bg-gray-50 p-4 rounded-xl mb-3">
            ...
            <Text className="text-sm text-gray-700 leading-5">
              ...
              discharge Kopano-Vertex Trading cc, its affiliates, directors,
              owners, and employees from any and all claims, demands,
              liabilities, suits, actions, and causes of action whatsoever,
              whether in law or equity, which may arise from or relate to the
              medical care, advice, diagnosis, treatment, or judgment provided
              by any independent healthcare professional connected through the
              platform.
            </Text>
          </View>
          <View className="ml-11 bg-gray-50 p-4 rounded-xl">
            ...
            <Text className="text-sm text-gray-700 leading-5">
              ...
              error is directly against the independent healthcare provider and
              not against Health_Connect.
            </Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          ...
          <Text className="text-base text-gray-700 leading-6 ml-11">
            ...
            medical care. You warrant that you will not use this platform for
            any medical emergency, and you accept full liability for any harm
            resulting from attempting to use this service in an emergency.
          </Text>
        </View>
