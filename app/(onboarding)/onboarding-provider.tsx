...
const OnboardingProviderScreen = () => {
  ...
  useEffect(() => {
    const checkOnboarding = async () => {
      try {
        ...
        console.error("Error checking onboarding flag (provider):", e);
      }
    };
  ...
  const completeOnboardingAndGoToSignIn = async () => {
    try {
      ...
      console.error("Error saving onboarding flag (provider):", e);
    }
    router.replace("/(root)/sign-in");
  };
        ...
        <View className="flex-1 px-6 justify-center items-center">
          ...
          <View className="items-center mb-6">
            ...
            <Text className="text-base text-gray-600 text-center px-6 leading-6">
              Streamline patient care with digital tools. Manage instant
              appointments and consultations all from one platform.
            </Text>
          </View>
