...
// --- Predefined Data ---
const issueTypes = [
  { label: 'Report Malpractice of Patient', value: 'Report Malpractice of Patient' },
...
export default function IssuesScreen() {
    ...
    const handleSubmitIssue = async () => {
      ...
      try {
        const CREATE_ISSUE_ENDPOINT = `/portal/issue/create-issue/${user.userId}`;
    ...
    const fetchMyTickets = useCallback(async () => {
      ...
      setIsLoading(true);
      try {
        const GET_ISSUES_ENDPOINT = `/portal/issue/all-issues/${user.userId}`;
    ...
    const fetchFaqs = useCallback(async () => {
        setIsLoading(true);
        try {
            const response = await apiClient.get('/portal/faq/all-faq');
